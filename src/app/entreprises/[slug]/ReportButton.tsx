...
const REASONS = ["Entreprise frauduleuse", "Contenu inapproprié", "Informations incorrectes", "Offres trompeuses", "Autre"];

export default function CompanyReportButton({ companyId }: { companyId: string }) {
  ...
  async function submit() {
    ...
    await fetch("/api/report", {
      ...
      body: JSON.stringify({ type: "COMPANY", targetId: companyId, reason, details: details || undefined }),
    });
    setLoading(false);
    setSent(true);
  ...
  return (
    <>
      ...
      >
        <Flag className="h-3.5 w-3.5" />Signaler cette entreprise
      </button>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-bold text-gray-900">Signaler cette entreprise</h3>
