    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <span className="text-red-600 font-semibold">Conseils carrière</span>
        </div>
      ...
      <div className="flex flex-wrap gap-2 mb-8 justify-center">
        {CATEGORIES.map((cat) => (
          <button
            key={cat}
            className="px-4 py-2 rounded-full text-sm font-medium border border-gray-200 hover:border-red-300 hover:bg-red-50 hover:text-red-700 transition-colors"
          >
            {cat}
          </button>
        ))}
      ...
      {/* Featured article */}
      <div className="bg-gradient-to-br from-red-600 to-red-500 rounded-2xl p-8 mb-8 text-white relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <button className="flex items-center gap-2 bg-white text-red-700 font-semibold px-5 py-2.5 rounded-xl hover:bg-red-50 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {articles.map((article) => {
          ...
          return (
            <article
              key={article.id}
              className="bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-md hover:border-red-100 transition-all cursor-pointer"
            >
      ...
      <div className="bg-gray-900 text-white rounded-2xl p-8 mt-12 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
          ...
          />
          <button className="bg-red-600 hover:bg-red-700 text-white px-5 py-2.5 rounded-xl text-sm font-medium transition-colors whitespace-nowrap">
            S&apos;abonner
          </button>
        </div>
